    ...
    $(function () {
        var BeAlert = {
            ...
            open: function (title, message, callback, o) {
                ...
                opts.showConfirmButton && confirmBtn.text(opts.confirmButtonText).css("display","inline-block"),
                opts.showCancelButton && cancelBtn.text(opts.cancelButtonText).css("display","inline-block");
