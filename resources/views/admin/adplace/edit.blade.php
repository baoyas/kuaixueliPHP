...
@section('content')
	<div class="main">
		<div class="title_big bline pb10"><span></span>位置编辑</div>
		@if (count($errors) > 0)
		...
		@endif
		<form action="{{url('admin/adplace/' . $file->id )}}" method="post" enctype="multipart/form-data">
			<input type="hidden" name="_method" value="put">
			{{csrf_field()}}
			<div class="inner mt15">
				<div class="form_row">
					<label class="first">位置名称</label>
					<input type="text" class="w-300" name="ad_place_name" value="{{$file->ad_place_name}}" />
