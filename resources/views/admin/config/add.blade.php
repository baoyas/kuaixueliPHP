            ...
            <div class="inner mt15 cf">
                <div class="left ml30">
                    <div class="form_row mt5">
                        ...
                        <input type="text" class="w-120" name="conf_title" />
                    </div>
                    <div class="form_row mt5">
                        <label class="only">名称</label>
                        <input type="text" class="w-160" name="conf_name" />
                    </div>
                    <div class="form_row">
                        <label class="only">类型</label>
                        <input type="radio"  value="input" id="" checked onclick="showtr()" name="field_type"> input　
                        <input type="radio"  value="textarea" id="" onclick="showtr()" name="field_type"> textarea　
                        <input type="radio"  value="checkbox" id="" onclick="showtr()" name="field_type"> checkbox
                    </div>
                    <div class="form_row mt5" id="field_value">
                        <label class="only">类型值</label>
                        <input type="text" class="w-200" name="field_value" />
                        <label class="info">类型值只有在checkbox的情况下才需要配置，格式1|开启,0|关闭</label>
                    </div>
                    <div class="form_row mt5">
                        <label class="only">排序</label>
                        <input type="text" class="w-200" name="conf_order" value="0" />
                    </div>
                    <div class="form_row mt5">
                        <label class="only">说明</label>
                        <textarea name="conf_tips" id="" cols="10" placeholder="配置项描述..." rows="5"></textarea>
                    </div>
